      ...
      <header className="absolute inset-x-0 top-0 z-50 py-2">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href={`${process.env.NODE_ENV === "development" ? "http://app.localhost:3000/login" : "https://app.quickval.co/login"}`} className="text-sm font-semibold leading-6 text-black">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                QuickVal helps you quickly set up landing pages to validate your product ideas so you don't have to waste time building products that don't sell.
              </p>
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a
                  href={`${process.env.NODE_ENV === "development" ? "http://app.localhost:3000/login" : "https://app.quickval.co/login"}`}
                ...
                <Link href="/about" className="text-sm font-semibold leading-6 text-blakc">
            ...
            <div className="mt-16 flow-root sm:mt-24">
              <div>
                <img
                  ...
                  width={2432}
                  height={1442}
                  className="rounded-md shadow-2xl ring-1 ring-black/10"
                />
              </div>
            </div>
          </div>
